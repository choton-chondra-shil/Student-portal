...
<body>
  ...
  <div class="body_section">
    ...
    <div id="container" class="right_part">
        ...
        <h2 style="color:rgb(47, 218, 176);">Welcome <label style="color:red;display:inline;font-weight:bolder"><?php echo $_SESSION['student_log']['first_name']." ".$_SESSION['student_log']['last_name'];?> !</label></h2>
        <div id="container">
