  ...
  <div id="header">
    ...
    <div id="container" class="body_Container_size_signup" >
            <div id="student-details">
              ...
              <label style="color:red;display:block;margin:20px 250px;"><?php if(isset($_POST['submit']) && ($new_password != $confirm_password)){echo $Insert_msg_error;}?></label>
              <label style="color:green;display:block;margin:20px 50px;"><?php if(isset($_POST['submit']) && ($new_password == $confirm_password)){echo $Insert_msg." and Your Unique ID : ";}?><label style="color:red;display:inline;"> <?php if(isset($_POST['submit']) && ($new_password == $confirm_password)){echo $uniqi_id." Save first Five(5) Digit of the Unique Id As a Student ID to Log In the Portal";}?></label></label>
          </div>
    <div id="footer">
