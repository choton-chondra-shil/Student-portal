...
if(isset($_POST['submit'])){
    ...
    $schedule = $_POST['schedule'];
      ...
      if($query == true){
        ...
        $error_conform_mgs = "Data Inserted";
      }
    }
    ...
    <div id="container" class="right_part ">
        ...
        <div id="container" class="course_right_part">
          ...
          <form action="add_course.php" method="POST">
            ...
            <label style="color:green;display:inline;margin-left:20px;margin-top:20px"><?php if(isset($_POST['submit']) && ($query == TRUE)){echo $conform_mgs;}?></label>
            <label style="color:red;display:inline;margin-left:20px;margin-top:20px"><?php if(isset($_POST['submit']) && ($query != TRUE)){echo $error_conform_mgs;}?></label>
          </form>
        </div>
          </div>
    </div>
